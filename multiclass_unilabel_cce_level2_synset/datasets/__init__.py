...
from .visual_genome_object import VisualGenomeObjectCatalog

def get_catalog(opt, split):
    if opt.dataset == 'visualgenome':
        catalog = VisualGenomeObjectCatalog(split, opt.image_dir, opt.preprocessed_data_dir, opt.preprocessed_pos_data, opt.dump_data_path,
