...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--run_dir', default='/dccstor/cssblr/amrita/Concept_Catalog_VQA/multiclass_unilabel_cce_level2_synset', type=str, help='experiment directory')
        ...
        self.parser.add_argument('--cluster_file', default='synset_concept_clusters_final.json', type=str, help='file containing clusters of attributes')
...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--preprocessed_pos_data_file', default='synset_regions_filtered_datasize100.pkl', type=str, help='file name consisting of the preprocessed positive data for validation')
