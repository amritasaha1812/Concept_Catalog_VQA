...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--run_dir', default='/dccstor/cssblr/amrita/Concept_Catalog_VQA/multiclass_unilabel_cce_synset', type=str, help='experiment directory')
        ...
        self.parser.add_argument('--glove_embedding_file', default='synset_glove_emb_filtered_datasize100.pkl', type=str, help='file containing glove embedding of class labels')
        ...
        self.parser.add_argument('--vocab_file', default='synset_concepts_final.json', type=str, help='file containing clusters of attributes')
        self.parser.add_argument('--cluster_file', default='synset_concept_clusters_final.json', type=str, help='file containing clusters of attributes')#grounded_vqa_concept_clusters.json', type=str, help='file containing clusters of attributes')
...
class TrainOptions(BaseOptions):
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--preprocessed_pos_data', default='synset_regions_filtered_datasize100.pkl', type=str, help='file name consisting of the preprocessed positive data for training')
        ...
        self.parser.add_argument('--cluster_classify', default=1, type=int, help='classify the label cluster instead of the label directly')
        self.is_train = True 
...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--preprocessed_pos_data', default='synset_regions_filtered_datasize100.pkl', type=str, help='file name consisting of the preprocessed positive data for validation')
